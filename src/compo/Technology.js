...
const Technology = () => {
  ...
  useEffect(()=>{
     const url ="https://node-project-backend-i9d271mrl-gauravmehra13.vercel.app/technology"  
  ...
  return (
    ...
    <div className="wrapper">
      ...
      Top Post
        ...
        <img src="https://images.indianexpress.com/2022/03/iphone-14-a16-chip-featured.jpg" alt="" className="top-post-image" />
